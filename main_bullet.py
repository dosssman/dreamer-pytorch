...
from dreamer.envs.bullet import PixelBasedBulletEnv
...
def build_and_train(log_dir, game="HopperBulletEnv-v0", run_ID=0, cuda_idx=None, eval=False, save_model='last', load_model_path=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--game', help='Bullet env.', default='HopperBulletEnv-v0')
